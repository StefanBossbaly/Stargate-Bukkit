...
import com.bflux.stargate.event.StargateActivateEvent;
import com.bflux.stargate.event.StargateCloseEvent;
import com.bflux.stargate.event.StargateCreateEvent;
import com.bflux.stargate.event.StargateDeactivateEvent;
import com.bflux.stargate.event.StargateOpenEvent;
import com.bflux.stargate.event.StargatePortalEvent;
...
public class Portal {
	...
	public void teleport(final Vehicle vehicle) {
		...
		if (passenger != null) {
			...
			// FIXME StorageMinecraft is no longer a class
			/*
	...
	public static Portal createPortal(SignChangeEvent event, Player player) {
		...
		StargateCreateEvent cEvent = new StargateCreateEvent(player, portal, event.getLines(), deny, denyMsg);
